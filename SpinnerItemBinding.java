...
public final class SpinnerItemBinding implements ViewBinding {
  ...
  private SpinnerItemBinding(@NonNull LinearLayout rootView, @NonNull TextView tdata) {
  ...
  public static SpinnerItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.tdata;
      TextView tdata = ViewBindings.findChildViewById(rootView, id);
      if (tdata == null) {
        break missingId;
      }

      return new SpinnerItemBinding((LinearLayout) rootView, tdata);
    }
